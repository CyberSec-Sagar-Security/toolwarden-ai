...
- Explainability (SHAP for the LightGBM layer, attention visualization for DeBERTa) attaches to any flagged decision so a human reviewing the approval queue can see which tokens/features drove it, not just a bare score.
